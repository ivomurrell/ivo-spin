...
fn DataBuffer(comptime T: type, buffer_type: u32) type {
    return struct {
...
pub const VertexBuffer = DataBuffer(Vertex, c.VK_BUFFER_USAGE_VERTEX_BUFFER_BIT);
pub const IndexBuffer = DataBuffer(u16, c.VK_BUFFER_USAGE_INDEX_BUFFER_BIT);
